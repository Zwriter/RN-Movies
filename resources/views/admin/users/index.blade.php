...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="fw-bold" style="color: #f5c518;">Manage Users</h1>
            <p class="text-muted mb-0">View users and update roles as needed.</p>
        </div>
    </div>
                    ...
                    <tbody>
                        @forelse($users as $user)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('admin.users.edit', $user) }}" class="btn btn-sm btn-outline-warning me-2">Edit</a>
